...
- `schema/control-page.md` — Page wrapper XML
- `schema/page-elements.md` — Element properties
- `schema/actions.md` — Action classes
- `schema/enums.md` — Enumeration values
- `images/device-images.md` — Image filenames
...
2. **Run the clipping script**:
   ```bash
   cat /tmp/control_page.xml | python3 ${CLAUDE_PLUGIN_ROOT}/tools/create_clipping.py ~/Desktop/PageName.textClipping
   ```
...
Load `export/clipping-export.md` during EXPORT phase.
